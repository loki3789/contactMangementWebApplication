...
-->
<?php
require_once(realpath($_SERVER["DOCUMENT_ROOT"]).'\contactManagement\app\controllers\contactsController.php');
...
include(realpath($_SERVER["DOCUMENT_ROOT"]) . '\contactManagement\app\views\index.php');
